(function () {
  ...
  .lm-opt{position:relative;min-height:120px;border-radius:18px;border:1px solid rgba(244,239,230,.12);cursor:pointer;background:rgba(244,239,230,.03);transition:transform .25s, border-color .2s, background .2s;text-align:left;padding:16px;display:flex;flex-direction:column;justify-content:space-between;gap:14px}
  .lm-opt:hover{transform:translateY(-3px);border-color:rgba(244,239,230,.5);background:rgba(244,239,230,.06)}
  .lm-opt-top{display:flex;justify-content:space-between;align-items:center}
  .lm-opt-tag{font:500 9px/1 Inter,sans-serif;letter-spacing:.28em;text-transform:uppercase;color:rgba(244,239,230,.6)}
  .lm-opt-kind{font:500 9px/1 Inter,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:rgba(244,239,230,.7);padding:5px 7px;border:1px solid rgba(244,239,230,.25);border-radius:6px}
  .lm-opt-name{font:600 20px/1.1 Fraunces,serif;color:#f4efe6}
  ...
  function renderPlayer(personaId) {
    ...
    var p = listing.personas.find(function (x) { return x.id === personaId; }) || listing.personas[0];
    var art = ART[p.id] || {};
